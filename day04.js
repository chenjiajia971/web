...
const add3 = () =>{return 3;}  //没有参数

const add4 = a => a + 1;   //只有一个参数
...
//改写
//先定义一个数组，在得到一个新数组
//新数组中的每个元素都是旧数组中的每个元素的平方，不用map的版本
const a1 = [1,2,3]
...
const sentence = 'The quick  brow fox jumped over the lazy dag';
